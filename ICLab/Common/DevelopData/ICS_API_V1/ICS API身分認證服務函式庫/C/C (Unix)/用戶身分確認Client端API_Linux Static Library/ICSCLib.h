// MOICA憑證用戶身分確認服務 Lib with Open SSL
...
//ShutDown
#define	SHUTDOWNRecv	0
#define	SHUTDOWNSend	1
#define	SHUTDOWNBoth	2
...
ICSReq封包範例:
<ICSReq>
<ClientID>E8FB5E4D8D42007602AC3C32484FF35E3B7CB1A6</ClientID>
...
/*
extern int iMake_ICSRequestPKT
(
...
/*
extern int iParse_ICSResponsePKT
(
...
// 提供Free的Function 
extern void vFreeData (char *szData);

//將Binary轉成hex 將二進位簽章值轉成16進位時用到
extern int bin2hex(unsigned char *input, int length, char *output);
